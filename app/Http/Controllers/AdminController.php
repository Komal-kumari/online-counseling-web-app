...
class AdminController extends Controller
{
    ...
    public function edit_therapist($id)
    {
        $therapist = Therapists::find($id);

        //Check for correct user

       return view('admin.therapist_edit')->with('therapist', $therapist);
    }

    public function update_therapist(Request $request, $id){
        ...
        return redirect('/admin/check_therapists')->with('success', 'Therapist User Updated');
