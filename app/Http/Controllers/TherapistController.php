...
class TherapistController extends Controller
{
            ...
            <div class="col-xl-4 col-md-6 mb-4 ">
              <div class="card border-0 shadow">
                ...
                <div class="card-body text-center">
                      ...
                      <div><button type="button" class="btn btn-primary mt-3" style="color: white;background-color: #4056F4 !important;"><a style="color: white;" href="therapists/profile/'.$row->id.'/Appointment">View Profile</a></button></div>
                   </div>
              </div>
            </div>';
    ...
    public function therapists_Appointments(){
      ...
      $therapist = Therapists::findorFail($therapist_id);
      $th = $therapist->Appointment()->paginate();
      // $th = Appointments::all()->where('therapist_id',$therapist_id)->all()->paginate(4);

if($th->count()==0){
  return view('Therapists.Therapists_Appointments',compact('ap','th'))->with('error','No data found!');
}
    ...
    public function cancel_Appointment($id){
      ...
      $therapist_id = Auth::guard('therapist')->user()->id;
      $therapist = Therapists::findorFail($therapist_id);
      $th = $therapist->Appointment()->paginate(4);


      $ap1 =Appointments::findorFail($id);
      $ap1->delete();
      return view ('Therapists.Therapists_Appointments',compact('ap','th'))->with('success','Appointment Cancelled!');
    }
