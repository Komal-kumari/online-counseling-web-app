...
<body>
	...
	<div class="home-two-style">
		...
		<header class="header-section">
            ...
            @Auth
               <a href="{{ url('/therapists/profile/{id}/Appointment')}}" class="site-btn">Get Appointment</a>
             @endAuth
                  ...
                  {{-- @if(Auth::guard('therapist')->check())
								...
								<div class="hero-info">
									...
									<ul>
										...
										<li><span>E-mail</span>{{$therapist->email}}</li>
							...
							<div class="col-lg-6 text-md-center">
								<figure class="hero-image">
									<img src="/storage/therapists/images/{{$therapist->image}}" alt="5">
								</figure>
							</div>
						</div>
					</div>
