...
Route::delete('admin/check_therapists/{id}','AdminController@delete_therapist')->name('delete_therapists');
...
Route::get('/therapists/search','TherapistController@search')->name('live_search');
Route::get('/therapists/profile/{id}','TherapistController@show');
Route::get('/therapist/profile/Appointments','TherapistController@therapists_Appointments')->middleware('auth:therapist');
Route::delete('/therapist/profile/Appointments/{id}','TherapistController@cancel_Appointment');


Route::get('/therapists/profile/{id}/Appointment','AppointmentsController@index');

Route::get('/Appointment/{id}','AppointmentsController@index');

Route::get('/Appointments','AppointmentsController@hasone');
Route::delete('/Appointments/{id}','AppointmentsController@cancel_Appointment');
